...
if __name__=="__main__":
    ...
    dataloader = torch.utils.data.DataLoader(dtset, batch_size=16, num_workers=4, collate_fn=custom_collate)
    for idx, data in tqdm.tqdm(enumerate(dataloader), total=int(np.ceil(len(dtset)/16))):
